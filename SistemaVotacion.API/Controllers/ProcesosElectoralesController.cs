...
namespace SistemaVotacion.API.Controllers
{
    ...
    public class ProcesosElectoralesController : ControllerBase
    {
        ...
        {
            var procesoElectoral = await _context.ProcesosElectorales.FindAsync(id);
        ...
        {
            _context.ProcesosElectorales.Add(procesoElectoral);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteProcesoElectoral(int id)
        {
            ...
            _context.ProcesosElectorales.Remove(procesoElectoral);
            await _context.SaveChangesAsync();
